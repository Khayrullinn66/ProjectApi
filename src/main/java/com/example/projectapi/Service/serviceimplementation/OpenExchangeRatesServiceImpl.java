package com.example.projectapi.Service.serviceimplementation;

import com.example.Client.OpenExchangeRatesClient;
import com.example.Model.ExchangeRate;
import com.example.Service.serviceinterface.ExchangeRatesService;
...
public class OpenExchangeRatesServiceImpl implements ExchangeRatesService {
    ...
    /**
     * Здесь юудет нам возращать список доступных для проверки валют.
     *
     * @return
     */
    @Override
